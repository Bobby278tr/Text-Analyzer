...
5. To install the react-router-dom execute the following command in ypur terminal
...
Project Link: [https://github.com/Bobby278tr/Text-Analyzer/](https://github.com/Bobby278tr/Text-Analyzer/)
